...
public class HighGearMotionMagicMove extends Command {
  ...
  public HighGearMotionMagicMove(double dist, double angle, double cruiseVelocity, int acceleration) {
    ...
    fGainLeft = 0.03977114f;
    fGainRight = fGainLeft - 0.0030f;
    pGainLeft = 0;
    pGainRight = 0;
    desiredAngle = angle;
  }
